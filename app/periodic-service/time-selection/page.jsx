...
const Page = (props) => {
  ...
  return (
    ...
    <div className="flex w-full pt-[28px] items-stretch pb-[6rem]">
      ...
      <div
        className={
          "flex items-start justify-between w-full lg:w-[calc(100%-424px)] lg:mr-auto bg-[#FDFDFD] lg:shadow-[0_0_6px_0_rgba(125,125,125,0.5)] lg:p-6 rounded-2xl min-h-[605px] relative"
        }
      >
          ...
          <p>{persianDateCovertor(data[0])}</p>
            ...
            <div className="absolute bottom-0 left-0 w-full justify-end flex bg-white p-4 rounded-2xl">
              <button
                ...
                className={`${timeIsSelected ? "bg-[#F66B34]" : "bg-[#FCCAAC]"} self-end hidden lg:flex items-center gap-2 mt-4 size690:mt-full w-fit text-12 size690:text-[16px] p-[8px] text-white rounded-[8px] min-w-[200px] justify-center`}
              >
                <p>تایید و ادامه</p>
