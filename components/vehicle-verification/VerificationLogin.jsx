    ...
    return (
        <div className='flex items-center justify-between w-[95%] size1180:w-[90%] size1275:w-[80%] m-auto py-[4rem]'>
            {(() => {
                switch (loginState) {
                    case('name') :
                        return <form onSubmit={nameAndMobileSubmitHandler} className='flex flex-col'>
                            <h2 className={'text-18 font-medium mb-[1.5rem]'}> برای ادامه اطلاعات فردی خود را وارد
                                کنید</h2>
                            <div
                                ...
                                <Input value={nameValue} on_change={nameChangeHandler} autoFocus type={'text'} foc
                                       ...
                                       id={'name'}/>
                                <label htmlFor={'name'}
                                       className='absolute top-[-40%] bg-white right-[3%] px-1 text-[#454545]'>نام
                                    و
                                    نام
                            ...
                            <div
                                ...
                                <label htmlFor={'mobile'}
                                       className='absolute top-[-40%] bg-white right-[3%] px-1 text-[#454545]'>شماره
                                    موبایل<span className={'text-red-500'}>*</span></label>

                            </div>
                            <div className={'flex items-center gap-1 mb-[1rem]'}>
                                <Input on_change={rulesChangeHandler} type={'checkbox'}
                                       className={'h-[22px] w-[22px]'}/>
                                <p className={'text-14'}><Link href='#' className={'text-RED_400'}>قوانین
                                    کارچک</Link> و <Link
