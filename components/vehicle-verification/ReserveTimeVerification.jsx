            ...
            >
              ...
              {(props.accordionState === undefined
                ...
                >
                  ...
                  <div
                    key={index}
                    className={`flex items-center p-2 ${timeIsSelected === item.id + "/" + +item.start + ":00" ? "border-b border-b-[#F66B34]" : ""} gap-6`}
                    onClick={(e) => {
                      item.swing_type
                        ...
                        : "";
                      setTimeStamp(item.start_timestamp);
                      timeIsSelected === item.id + "/" + item.start + ":00"
                        ? setTimeIsSelected(null)
                        : setTimeIsSelected(item.id + "/" + item.start + ":00");
                    }}
                  >
                    <p>{item.start + ":00"}</p>
                    <div
                    ...
                    >
                      <div
                        className={`size-[10px] m-auto rounded-[50%] transition-all duration-500 ease-out  ${timeIsSelected === item.id + "/" + +item.start + ":00" ? "bg-[#F66B34]" : ""}`}
                      ></div>
                    </div>
                  </div>
                  {/*    second time*/}
                  <div
                    key={index}
                    className={`flex items-center p-2 ${timeIsSelected === item.id + "/" + (+item.start + 1) + ":00" ? "border-b border-b-[#F66B34]" : ""} gap-6`}
                    onClick={(e) => {
                      item.swing_type
                        ? props.setFluctuation({
                            type: item.swing_type,
                  ...
                  >
                    ...
                    >
                      <div
                        className={`size-[10px] m-auto rounded-[50%] transition-all duration-500 ease-out ${timeIsSelected === item.id + "/" + (+item.start + 1) + ":00" ? "bg-[#F66B34]" : ""}`}
                      ></div>
                    </div>
                  </div>
                  {/*    third time*/}
                  <div
                    key={index}
                    className={`flex items-center p-2 ${timeIsSelected === item.id + "/" + +item.start + ":30" ? "border-b border-b-[#F66B34]" : ""} gap-6`}
                    onClick={(e) => {
                      item.swing_type
                        ? props.setFluctuation({
                            type: item.swing_type,
                        ...
                        : "";
                      setTimeStamp(item.start_timestamp);
                      timeIsSelected === item.id + "/" + item.start + ":30"
                        ? setTimeIsSelected(null)
                        : setTimeIsSelected(item.id + "/" + item.start + ":30");
                    }}
                  >
                    <p>{item.start + ":30"}</p>
                    <div
                    ...
                    >
                      <div
                        className={`size-[10px] m-auto rounded-[50%] transition-all duration-500 ease-out ${timeIsSelected === item.id + "/" + +item.start + ":30" ? "bg-[#F66B34]" : ""}`}
                      ></div>
                    </div>
                  </div>
                  {/*    forth time*/}
                  <div
                    key={index}
                    className={`flex items-center p-2 ${timeIsSelected === item.id + "/" + (+item.start + 1) + ":30" ? "border-b border-b-[#F66B34]" : ""} gap-6`}
                    onClick={(e) => {
                      item.swing_type
                        ? props.setFluctuation({
                            type: item.swing_type,
                  ...
                  >
                    ...
                    >
                      <div
                        className={`size-[10px] m-auto rounded-[50%] transition-all duration-500 ease-out ${timeIsSelected === item.id + "/" + (+item.start + 1) + ":30" ? "bg-[#F66B34]" : ""}`}
                      ></div>
                    </div>
                  </div>
                </div>
