...
const VerificationLastStep = () => {
    return (
        <div className={'w-[90%] size1000:w-[80%] size1136:w-[70%] m-auto pt-[2rem]'}>
            <div className={'flex items-center gap-2 size752:gap-[16px] text-BLUE_600 w-full mb-4'}>
                ...
                <p className={'p-[6px] text-14 size752:text-16 w-full border-b border-BLUE_600'}>سرویس مد نظر خود را
                    انتخاب کنید</p>
            </div>
            ...
            <div className={'mt-[36px] w-full size1000:w-[60%]'}>
                ...
                <div
                    className={'rounded-lg border border-[#B0B0B0] h-[3rem] flex items-center relative pr-3 mb-[2rem]'}>
                    <i className='cc-user border-l-[2px] border-l-[#B0B0B0] pl-2 text-[#3D3D3D] text-[20px]'/>
                    <Input autoFocus type={'text'} foc
                           className={'w-full h-full rounded-lg outline-none pr-1 text-[#3D3D3D]'}
                           id={'name'}/>
                    <label htmlFor={'name'}
                           className='absolute top-[-30%] bg-white right-[3%] px-1 text-14 text-[#454545]'>کد تخفیف
                        <span className={'text-red-500'}>*</span></label>
                    <button className={'bg-BLUE_700 text-white py-[10px] px-[3rem] rounded-lg self-end h-full'}>
                        تایید
                    </button>
                </div>
            </div>
            ...
            <div className={'w-full size1000:w-[60%] border-t pt-4 border-t-[#E8E6E6] flex items-center justify-between'}>
