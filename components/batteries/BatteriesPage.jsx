...
const BatteriesPage = () => {
    ...
    return (
        <Fragment>
            <div
                className="w-[95%] size671:w-[98%] size1090:w-[95%] m-auto flex flex-col size1056:flex-row gap-[1rem] size1275:gap-[3rem]">
                <div
                    className="w-full size671:w-[70%] size720:w-[48%] size1136:w-[45%] size1000:pt-[9rem] size1056:pt-0 mt-[1rem] self-center size1056:self-auto">
                    <SelectVehicleBox
                        tabTitle={tabTitle}
                ...
                <div className="pt-0 size1056:pt-[9rem] w-full mt-[1rem] flex flex-col gap-[1.5rem]">
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <Button
                            class_name="bg-[#D9D9D9] rounded-[8px] py-[0.5rem] px-[1.5rem] flex items-center gap-[0.5rem] text-text_gray">
                ...
                {batteryIsSelected && (
                    <div
                        className="w-[75%] size900:w-[50%] m-auto fixed top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] z-[15]">
