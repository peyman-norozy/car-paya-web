    ...
    return (
        <form className="max-w-md m-auto my-[80px]  " onSubmit={formSubmitHandler}>
            <div className="border-t-4 border-red-500 overflow-hidden rounded shadow-lg">
                ...
                <p className={"text-12 text-red-500 pr-4"}>{newErrorRegister["first_name"] && newErrorRegister["first_name"][0]}</p>
                <div className="flex flex-col gap-2 m-3">
                    <Label
                        text="نام خانوادگی:"
                ...
                <p className={"text-12 text-red-500 pr-4"}>{newErrorRegister["last_name"] && newErrorRegister["last_name"][0]}</p>
                <div className="flex flex-col gap-2 m-3">
                    <Label
                        text="ایمیل:"
                ...
                <p className={"text-12 text-red-500 pr-4"}>{newErrorRegister.email && newErrorRegister.email[0]}</p>
                ...
                <p className={"text-12 text-red-500 pr-4"}>{newErrorRegister.password && newErrorRegister.password[0]}</p>
                <div className="flex flex-col gap-2 m-3">
                    <Label
                        text="جنسیت:"
                        htmlFor="gender"
                ...
                <p className={`text-12 text-red-500 pr-4 ${newErrorRegister.gender ? "pb-4" : "pb-0"}`}>{newErrorRegister.gender && newErrorRegister.gender[0]}</p>
