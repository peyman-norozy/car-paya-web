const LoginModal = () => {
  return (
    <div className="fixed bottom-0 right-0 w-screen p-7 flex flex-col items-center gap-10 z-[3000] bg-white shadow-[0_0_8px_0_rgba(175,175,175,0.25)] rounded-t-3xl">
      ...
      <div className="flex flex-col items-center gap-6 w-full">
        <div className="flex flex-col items-start gap-4 w-full">
          ...
          <div className="relative w-full flex items-center border border-[#B0B0B0] px-3 py-2 rounded-lg gap-3">
            ...
            <input
              className="outline-none text-black text-sm placeholder:text-[#3D3D3D] w-full"
        ...
        <div className="flex flex-col gap-2 w-full items-center">
          ...
          <span className="text-10 flex gap-[2px]">ورود شما به معنای پذیرش<span className="text-[#1E67BF]">شرایط کار پایا</span>و<span className="text-[#1E67BF]">قوانین حریم خصوصی</span>است</span>
        </div>
      </div>
    </div>
  );
