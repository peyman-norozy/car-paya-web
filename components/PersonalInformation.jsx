...
const PersonalInformation = () => {
    return (
        <div className={"bg-white w-full flex-1 rounded-[15px] size460:py-8 size460:px-16 px-8 py-4 shadow-[0_0_6px_0_rgba(177,177,177,1)]"}>
            <form className={"flex flex-col gap-[43px]"}>
                ...
                <button type={"submit"} className={"bg-[#354597] w-[150px] h-[40px] size460:self-end self-center mt-[50px] text-[#F6F6F6] rounded-[10px] hover:bg-[#354960]"}>ثبت تغییرات</button>
            </form>
        </div>
    );
};
