...
const Counseling = () => {
  return (
    <div className="relative overflow-hidden pt-16">
      <div className="lg:w-[518px] w-[282px] lg:h-[219px] h-[174px] flex flex-col items-center bg-white gap-5 py-5 px-6 m-auto relative z-[2] shadow-[0_0_4px_0_rgba(171,171,171,0.25)] justify-evenly">
