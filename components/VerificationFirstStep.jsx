                        ...
                        <div
                            ...
                            <div className={'relative'}>
                                ...
                                <div className={'absolute right-[4%] top-[10%] size690:top-[20%] flex flex-col gap-2'}>
                                    ...
                                    <button onClick={PackageStepHandler} className={'bg-BLUE_700 mt-1 size690:mt-3 lg:hidden w-fit text-12 size690:text-[16px] p-[8px] text-white rounded-[4px]'}> درخواست کارشناسی</button>
                                </div>
                            </div>
                        </div>
                    </div>
