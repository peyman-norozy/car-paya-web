...
const BatterySelectVerificationPlace = (props) => {
  const {
    title,
    description,
    id,
  ...
  //   .get(
  //     process.env.BASE_API +
  //       "/web/expert/reservation/battery?step=step-5&type=DELEGATE&city_id=" +
  //       city_id +
...
export default BatterySelectVerificationPlace;
