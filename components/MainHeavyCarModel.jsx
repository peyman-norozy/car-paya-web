...
const MainHeavyCarModel = (props) => {
    const backClickHandler = () => {
        props.setMainHeavyCarBrandModalDisplay(true)
        props.setMainHeavyCarModelDisplay(false)
    };

    return (
        <div className="flex flex-col gap-4 mt-4 w-full">
            <div className="flex justify-end">
                <span className="flex-1 text-center font-medium text-[#FEFEFE]">انتخاب مدل</span>
                <Image
            ...
            <div>
                <input
                    ...
                    onChange={props.heavycarModelSearchHandler}
                />
            </div>

            <div className="max-h-[290px] w-full overflow-y-scroll grid grid-cols-3 gap-4 py-4">
                {props.searchedMainHeavyCarModelData.map((item, index) => (
...
export default MainHeavyCarModel;