...
const SpecialOffersSliderCard = () => {
  return (
    <div className="bg-white overflow-hidden shadow-lg flex-1 flex flex-col h-auto items-center justify-between gap-4 text-14 rounded-xl bg-[url(/assets/images/carAnalyse.jpeg)] bg-no-repeat bg-cover bg-center relative">
