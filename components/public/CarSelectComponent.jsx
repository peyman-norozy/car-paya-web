...
const CarSelectComponent = () => {
  ...
  return (
    <div className={"absolute h-full pb-[16px] top-0 right-0"}>
      <div
        className={`bg-[#383838A3] h-[605px] rounded-2xl w-[400px] sticky top-[123px] right-auto z-[2] backdrop-blur-[16px] p-4 hidden lg:flex flex-col gap-4`}
      >
        {carSelected ? (
