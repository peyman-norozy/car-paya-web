  ...
  if (footerState) {
    return (
      <div className="fixed bottom-2 right-2 z-[2000] flex items-center w-[calc(100%-16px)] h-[60px] rounded-3xl shadow-[0_4px_4px_0_rgba(160,160,160,0.20)]">
        ...
        <div
          className={`z-[2003] w-screen h-[570px] bg-[#FEFEFE] fixed right-0 flex justify-center ${modalIsOpen ? "bottom-0" : "bottom-[-580px]"}  transition-all duration-700 rounded-t-3xl`}
        >
          {/* <VehicleRegistration /> */}
          <CarSelectComponent
            isMobile={true}
