    ...
    >
      <div className="flex flex-col w-full gap-4 max-w-[620px] m-auto lg:m-0">
        ...
        <div className="flex flex-col gap-4">
          <span className="font-medium text-sm lg:text-base">دسترسی سریع</span>
      ...
      <div className="w-full flex flex-col gap-6 max-w-[620px] m-auto lg:m-0">
        ...
        <div className="flex gap-1 items-start">
          <i className="cc-calling text-xl text-[#F58052]"/>
          <span className="text-sm lg:text-base leading-6">میدان جهاد ، خیابان اسدآبادی ، نبش کوچه انصاری ، پلاک 134 ، واحد 10</span>
        </div>
