  ...
  return (
    ...
    >
      <div className={"max-w-[1600px] m-auto"}>
        <div>
          <div className="size900:px-[138px] size752:px-[210px] size671:px-[190px] size460:px-[100px] size366:px-[50px] px-[10px]">
          ...
          <div className="grid size900:grid-cols-3 grid-cols-1 gap-[24px] mt-[90px] pb-[10px] size900:px-[138px] size752:px-[210px] size671:px-[190px] size460:px-[100px] size366:px-[50px] px-[10px] text-white">
        ...
        <div className="bg-white flex size671:flex-row flex-col items-center justify-around text-14 absolute right-0 left-0">
          <p className="size900:text-[14px] text-[12px] py-2">
